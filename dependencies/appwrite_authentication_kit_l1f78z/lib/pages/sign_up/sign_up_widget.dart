                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Flexible(
                              child: wrapWithModel(
                                model: _model.authSignupDesktopCardModel,
                                updateCallback: () => safeSetState(() {}),
                                child: AuthSignupDesktopCardWidget(),
                              ),
                            ),
                          ],
                        ),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              ...
                              alignment: AlignmentDirectional(0.0, 0.1),
                              image: Image.asset(
                                'packages/appwrite_authentication_kit_l1f78z/assets/images/bg-tablet.png',
                              ).image,
                            ),
                            borderRadius: BorderRadius.circular(0.0),
                            shape: BoxShape.rectangle,
                          ...
                          children: [
                            Align(
                              ...
                              child: Container(
                                ...
                                child: wrapWithModel(
                                  model: _model.authSignupTabletCardModel,
                                  updateCallback: () => safeSetState(() {}),
                                  child: AuthSignupTabletCardWidget(),
                                ),
                              ),
                            ),
                          ],
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: wrapWithModel(
                                      model: _model.authSignupMobileCardModel,
                                      updateCallback: () => safeSetState(() {}),
                                      child: AuthSignupMobileCardWidget(),
                                    ),
                                  ),
                                ),
                              ),
