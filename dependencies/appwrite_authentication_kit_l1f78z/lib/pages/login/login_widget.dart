                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              ...
                              image: Image.asset(
                                'packages/appwrite_authentication_kit_l1f78z/assets/images/bg-desktop.png',
                              ).image,
                            ),
                                ...
                                children: [
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 32.0),
                                    child: wrapWithModel(
                                      model: _model.authLoginDesktopCardModel,
                                      updateCallback: () => safeSetState(() {}),
                                      child: AuthLoginDesktopCardWidget(),
                                    ),
                                  ),
                                ],
                              ),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              ...
                              alignment: AlignmentDirectional(0.0, 0.1),
                              image: Image.asset(
                                'packages/appwrite_authentication_kit_l1f78z/assets/images/Frame_144386.png',
                              ).image,
                            ),
                            borderRadius: BorderRadius.circular(0.0),
                            shape: BoxShape.rectangle,
                      ...
                      child: Container(
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              wrapWithModel(
                                model: _model.authLoginTabletCardModel,
                                updateCallback: () => safeSetState(() {}),
                                child: AuthLoginTabletCardWidget(),
                              ),
                            ],
                          ),
                        ),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              ...
                              alignment: AlignmentDirectional(0.0, 0.0),
                              image: Image.asset(
                                'packages/appwrite_authentication_kit_l1f78z/assets/images/bg.png',
                              ).image,
                            ),
                            borderRadius: BorderRadius.circular(0.0),
                            shape: BoxShape.rectangle,
                          ...
                          child: Column(
                            ...
                            children: [
                              Align(
                                alignment: AlignmentDirectional(0.0, 0.0),
                                child: wrapWithModel(
                                  model: _model.authLoginMobileCardModel,
                                  updateCallback: () => safeSetState(() {}),
                                  child: AuthLoginMobileCardWidget(),
                                ),
                              ),
                            ],
                          ),
