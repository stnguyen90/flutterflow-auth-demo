...
import 'auth_mobile_card_model.dart';
export 'auth_mobile_card_model.dart';

class AuthMobileCardWidget extends StatefulWidget {
  const AuthMobileCardWidget({super.key});

  @override
  State<AuthMobileCardWidget> createState() => _AuthMobileCardWidgetState();
}

class _AuthMobileCardWidgetState extends State<AuthMobileCardWidget> {
  late AuthMobileCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthMobileCardModel());
