...
class AuthDesktopCardWidget extends StatefulWidget {
  const AuthDesktopCardWidget({super.key});

  @override
  State<AuthDesktopCardWidget> createState() => _AuthDesktopCardWidgetState();
}

class _AuthDesktopCardWidgetState extends State<AuthDesktopCardWidget> {
  late AuthDesktopCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthDesktopCardModel());
