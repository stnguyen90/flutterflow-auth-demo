...
import 'btn_sign_out_tablet_model.dart';
export 'btn_sign_out_tablet_model.dart';

class BtnSignOutTabletWidget extends StatefulWidget {
  const BtnSignOutTabletWidget({super.key});

  @override
  State<BtnSignOutTabletWidget> createState() => _BtnSignOutTabletWidgetState();
}

class _BtnSignOutTabletWidgetState extends State<BtnSignOutTabletWidget> {
  late BtnSignOutTabletModel _model;
